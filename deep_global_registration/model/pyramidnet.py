...
from deep_global_registration.model.common import get_norm, get_nonlinearity

from deep_global_registration.model.residual_block import get_block, conv, conv_tr, conv_norm_non
