...
from deep_global_registration.model.residual_block import conv, conv_tr, get_block
...
class ResUNet(ME.MinkowskiNetwork):
  ...
  REGION_TYPE = ME.RegionType.HYPERCUBE  #change HYPERCUBE to HYPERCUBE
...
class ResUNetBNFX(ResUNetBNF):
  REGION_TYPE = ME.RegionType.HYPERCROSS  #change HYPERCROSS to HYPERCROSS
