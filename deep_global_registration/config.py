...
trainer_arg.add_argument('--clip_weight_thresh', type=float, default=0.05, help='Weight threshold for detecting inliers') #0.05
...
inlier_arg.add_argument('--inlier_feature_type', type=str, default='ones') # ['ones', 'feats', 'coords'] ones default
